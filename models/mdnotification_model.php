            ...
            $rs = $this->db->SelectLimit("
                ...
                FROM (
                    SELECT 
                        ...
                        N.NOTIFICATION_TYPE_ID AS NOTIFICATIONTYPEID, 
                        N.IS_NO_MSG_SUBSTR, 
                        ".$this->db->IfNull("TO_CHAR(NU.CREATED_DATE, 'YYYY-MM-DD HH24:MI:SS')", 'NU.NOTIFY_DATE')." AS NOTIFYDATE, 
                        TO_CHAR(N.CREATED_DATE, 'YYYY-MM-DD HH24:MI:SS') AS CREATED_DATE, 
                    ...
                    GROUP BY N.NOTIFICATION_ID,
                        ...
                        N.IS_NO_MSG_SUBSTR,
                        ".$this->db->IfNull("TO_CHAR(NU.CREATED_DATE, 'YYYY-MM-DD HH24:MI:SS')", 'NU.NOTIFY_DATE').",
                        TO_CHAR(N.CREATED_DATE, 'YYYY-MM-DD HH24:MI:SS'),
                        NU.NOTIFICATION_USER_ID,
                        NU.VIEWED_DATE,
                        NT.ICON,
