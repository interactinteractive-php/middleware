...
function recursivePushObj(tmpObj, tmp, value) {
...
function convertOptions (chartConfig, option) {
    var tmp = {}
...
function kpiDataMartEChartBuildRender(obj) {
...
function chartConfigrationToggle($mainSelector, _dataConfigStr) {
...
function kpiDataMartEChartSetOption(obj) {
    var elemId = obj.elemId;
    var $mainSelector = $('#' + elemId).closest('.theme-builder');
    var chartConfig = obj.chartConfig;
    var useData = obj.useData;
    ...
    var isLayoutBuilder = false, kpiLayoutIndex = 0;
/* 
    console.log(JSON.parse(chartConfig.buildCharConfig));
    return false; */
