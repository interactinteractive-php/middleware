...
<div class="w-100" id="sales_widget_window_<?php echo $this->uniqId; ?>">
    <div class="head">
        <br>
        <div>
            <h2 style="margin: 0 auto; display: table">Ривер Клуб</h2>
    ...
    <div class=" mt-2 mb-4">
        ...
        <div class="col-md-6 col-sm-6 " style="background-color:#fff; padding-right: 0px">
            <p style="font-size: 15px; font-weight: bold;">Бүтээгдэхүүний төрлөөр</p>
            <div id="sales_widget_chart_<?php echo $this->uniqId; ?>" style="border: 2px solid rgb(155,187,89); height:420px; margin-right: 10px;"></div> 
        </div>
        <div class="col-md-6 col-sm-6 mt-3" style="background-color:#fff;">   
             <p style="font-size: 15px; font-weight: bold;">Топ 5-н борлуулалт </p>
            <div id="sales_widget_chart_member_<?php echo $this->uniqId; ?>" style=" min-height:414px; border: 2px solid rgb(155,187,89); padding:20px; ">
                <table class="table table-hover" id="top5sale" style="margin-top: 50px;">
