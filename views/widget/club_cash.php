...
<div id="cash_widget_window_<?php echo $this->uniqId; ?>">
    <div class="col-md-12">
        <br>
        <div>
    ...
    <div class="col-md-12 col-sm-12 mt15">
        <div class="col-md-12 col-sm-12" style="background-color: rgb(204,255,102);">
                <?php
    ...
    <div class="W-100 no-padding m-0 mt15"> 
        <div class="mt20" style="background-color:#fff">
            <div id="serial1_dashboard_<?php echo $this->uniqId; ?>" class="w-100" style="border: 1px solid rgb(155,187,89); min-height:420px; "></div>
            <br>
        </div>
    </div>

    <div class="row no-padding m-0">    
        <div class="col-md-6 col-sm-6 mt20" style="background-color:#fff; ">
            <p style="font-size: 15px; font-weight: bold;">Кассын орлогын мэдээ</p>
            <div id="cash_widget_chart_<?php echo $this->uniqId; ?>" style="border: 1px solid rgb(155,187,89);min-height:420px;" class="mt20"></div>	
        </div>
        <div class="col-md-6 col-sm-6 mt20" style="background-color:#fff; ">
            <p style="font-size: 15px; font-weight: bold;">Кассын зарлагын мэдээ</p>
            <div id="cash_widget2_chart_<?php echo $this->uniqId; ?>" style="border: 1px solid rgb(155,187,89); min-height:420px;" class="mt20"></div>	
        </div>
    </div>   
