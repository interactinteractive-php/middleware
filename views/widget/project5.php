            ...
            <div class="col-md-6">
                <div class="main-title-<?php echo $this->uniqId ?>">
                    <h2 class="h2_style_v2" style="margin: 18px 0px 0 50px;">
                        ...
                        <?php echo $this->lang->line('execDB11_0'); ?>
                    </h2>
                </div>
            </div>
...
<div class="col-lg-12 col-md-12 col-sm-12 mt20">
    ...
    <div class="col-md-12 col-sm-12" style="background-color:#fff; margin-top: 20px">
        <p style="font-size: 15px; font-weight: bold; text-align: center"><?php echo $this->lang->line('execDB11_8'); ?></p>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12" style="background-color:#fff; margin-top: 20px">
            <p style="font-size: 15px; font-weight: bold; text-align: center"><?php echo $this->lang->line('execDB11_5'); ?></p>
            <div id="sales_widget_chart_222<?php echo $this->uniqId; ?>"></div>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-12" style="background-color:#fff; margin-top: 20px">
            <p style="font-size: 15px; font-weight: bold; text-align: center"><?php echo $this->lang->line('execDB11_7'); ?></p>
    ...
    <div class="col-md-4 col-sm-4" style="background-color:#fff;">
        <div class"row">
            <div class="col-md-9">
                <p style="font-size: 15px; font-weight: bold; text-align: center"><?php echo $this->lang->line('execDB11_4'); ?></p>
                <div id="sales_widget_chart2_<?php echo $this->uniqId; ?>"></div>	    
            </div>
            <div class="col-md-3" style="height:300px;background-color:rgb(36,184,253);text-align:center">
        ...
        <div class"row">
        <div class="col-md-9">
            <p style="font-size: 15px; font-weight: bold; text-align: center"><?php echo $this->lang->line('execDB11_3'); ?></p>
            <div id="serial1_dashboard_<?php echo $this->uniqId; ?>"></div>
        </div>
            <div class="col-md-3" style="height:300px;background-color:rgb(91,203,255);text-align:center">
        ...
        <div class"row">
        <div class="col-md-9">        
            <p style="font-size: 15px; font-weight: bold; text-align: center"><?php echo $this->lang->line('execDB11_9'); ?></p>
            <div id="serial11_dashboard_<?php echo $this->uniqId; ?>"></div>
        </div>
        <div class="col-md-3" style="height:300px;background-color:rgb(163,226,255);text-align:center">
        ...
        <br>
        <div class="clearfix w-100"></div>
        <p style="font-size: 15px; font-weight: bold; text-align: center"><?php echo $this->lang->line('execDB11_2'); ?></p>
...
<script type="text/javascript">
    ...
    $(document).on('click', '#date-filter', function(){
        ...
        window.location = URL_APP + 'dashboard/project5/' + sd + '/' + ed + '/' + depsStr + '/' + isHierarchy;
    });
