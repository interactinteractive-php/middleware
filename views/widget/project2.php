            ...
            <div class="col-md-6">
                <div class="main-title-<?php echo $this->uniqId ?>">
                    <h2 class="h2_style_v2" style="margin: 18px 0px 0 50px;">
                        ...
                        <?php echo $this->lang->line('execDB6_0'); ?>
                    </h2>
                </div>
            </div>
...
<div class="col-md-12 col-sm-12 mt20">
    ...
    <div class="col-md-12 col-sm-12" style="background-color:#fff;">
        ...
        <p style="font-size: 15px; font-weight: bold; text-align: center"><?php echo $this->lang->line('rexecDB6_2'); ?></p>
        <div id="sales_widget_chart_<?php echo $this->uniqId; ?>"></div>	
        </div>
        <div class="col-md-6 col-sm-6" style="padding: 4px;">
            <p style="font-size: 15px; font-weight: bold; text-align: center"><?php echo $this->lang->line('rexecDB6_5'); ?></p>
            <div id="sales_widget_chart_222<?php echo $this->uniqId; ?>"></div>
        </div>        
        <div class="clearfix w-100"></div>
        <div class="col-md-6 col-sm-6" style="padding: 4px;">
            <p style="font-size: 15px; font-weight: bold; text-align: center"><?php echo $this->lang->line('rexecDB6_6'); ?></p>
            <div id="serial111_dashboard_<?php echo $this->uniqId; ?>"></div>
        </div>    
        <div class="col-md-6 col-sm-6" style="padding: 4px;">
            <p style="font-size: 15px; font-weight: bold; text-align: center"><?php echo $this->lang->line('rexecDB6_7'); ?></p>
    ...
    <div class="col-md-4 col-sm-4" style="background-color:#fff;">
        <div class="" style="background-color:#fff; margin-top: 20px;">   
            <p style="font-size: 15px; font-weight: bold; text-align: center"><?php echo $this->lang->line('rexecDB6_1'); ?></p>
        ...
        <br>
        <p style="font-size: 15px; font-weight: bold; text-align: center"><?php echo $this->lang->line('rexecDB6_3'); ?></p>
        <div id="serial1_dashboard_<?php echo $this->uniqId; ?>"></div>
        <br>
        <p style="font-size: 15px; font-weight: bold; text-align: center"><?php echo $this->lang->line('rexecDB6_4'); ?></p>
...
<script type="text/javascript">
    ...
    $(document).on('click', '#date-filter', function(){
        ...
        window.location = URL_APP + 'dashboard/project2/' + sd + '/' + ed + '/' + depsStr + '/' + isHierarchy;
    });
    ...
    for(var i = 0; i < chart.dataProvider.length; i++) {
        if(i == 0)
            chart.dataProvider[i].color = "rgb(154,111,172)";
        if(i == 1)
            chart.dataProvider[i].color = "rgb(148,137,189)";
        if(i == 2)
            chart.dataProvider[i].color = "rgb(143,159,201)";
        if(i == 3)
            chart.dataProvider[i].color = "rgb(135,185,215)";
        if(i == 4)
            chart.dataProvider[i].color = "rgb(131,212,231)";
    }      
