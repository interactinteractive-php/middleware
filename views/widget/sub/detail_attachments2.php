...
<style type="text/css">
/*.bpdtl-widget-detail_attachments2 .tbody {
    display: inline;
}*/
.bpdtl-widget-detail_attachments2 .bp-detail-row {
    display: block;
    position: relative;
    padding: 10px 0;
    border-radius: 8px;
...
.bpdtl-widget-detail_attachments2 .bp-detail-row .media-body .line-height-normal {
    margin-bottom: 5px;
    overflow: hidden;
...
.bpdtl-widget-detail_attachments2 .bp-detail-row .media i {
    font-size: 38px;
}
.bpdtl-widget-detail_attachments2 .bp-detail-row .media img {
    max-width: 40px;
}
.bpdtl-widget-detail_attachments2 .bp-detail-row .bp-remove-row {
    display: none;
    position: absolute;
    top: -8px;
    right: -2px;
...
.bpdtl-widget-detail_attachments2 .bp-detail-row:hover .bp-remove-row {
    display: inline-block;
}
.bpdtl-widget-detail_attachments2 .bp-detail-row-add {
    display: inline;
}
</style>