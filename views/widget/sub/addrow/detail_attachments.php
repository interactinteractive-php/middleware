...
<style type="text/css">
.bpdtl-widget-detail_attachments .tbody {
    display: inline;
}
.bpdtl-widget-detail_attachments .bp-detail-row {
...
.bpdtl-widget-detail_attachments .bp-detail-row .media-body .line-height-normal {
    margin-bottom: 5px;
    overflow: hidden;
...
.bpdtl-widget-detail_attachments .bp-detail-row .media i {
    font-size: 38px;
}
.bpdtl-widget-detail_attachments .bp-detail-row .bp-remove-row {
    display: none;
    position: absolute;
    top: -12px;
    right: -2px;
...
.bpdtl-widget-detail_attachments .bp-detail-row:hover .bp-remove-row {
    display: inline-block;
}
.bpdtl-widget-detail_attachments .bp-detail-row-add {
    display: inline;
}
</style>