    ...
    <?php if($this->jsonAttr["renderType"] !="img") { ?>
        <div class="slick-carousel2<?php echo $uid; ?> slickwidget">
            <div class="relative w-full h-full rounded-xl">
                <img data-tposition="position1" data-tpath="" src="https://dev.veritech.mn/storage/uploads/process/202402/shutterstock_1201594333-2-scaled-e1684852713333-1120x300.jpg" alt="Banner image" class="w-100 object-center object-fill block rounded-xl">
            </div>    
            <div class="relative w-full h-full rounded-xl">
                <img data-tposition="position1" data-tpath="" src="https://dev.veritech.mn/storage/uploads/process/202402/shutterstock_9623992-1120x300.jpg" alt="Banner image" class="w-100 object-center object-fill block rounded-xl">
            </div>    
            <div class="relative w-full h-full rounded-xl">
                <img data-tposition="position1" data-tpath="" src="https://dev.veritech.mn/storage/uploads/process/202402/Data-aggregation-shutter-stock-1120x300.jpg" alt="Banner image" class="w-100 object-center object-fill block rounded-xl">
            </div>    
        </div>
    <?php }else{ ?> 
...
<script>
    ...
    setTimeout(function() {
        $(".slick-carousel2<?php echo $uid; ?>").css("width", $(window).width() -560);
    }, 10);
</script>