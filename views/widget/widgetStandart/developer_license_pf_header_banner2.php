    ...
    <?php if($this->jsonAttr["renderType"] !="img") { ?>
        <div class="slick-carousel2<?php echo $uid; ?> slickwidget">
            <div class="relative w-full h-full rounded-xl">
                <img data-tposition="position1" data-tpath="" src="https://www.ziptechservices.co.uk/wp-content/uploads/leio-mclaren-leiomclaren-com-FwdZYz0yc9g-unsplash-1500x300.jpg" alt="Banner image" class="w-100 object-center object-fill block rounded-xl">
            </div>    
            <div class="relative w-full h-full rounded-xl">
                <img data-tposition="position1" data-tpath="" src="https://i0.wp.com/www.newburg.com.au/wp-content/uploads/2018/11/Software_Development1-1500x300.jpg" alt="Banner image" class="w-100 object-center object-fill block rounded-xl">
            </div>    
            <div class="relative w-full h-full rounded-xl">
                <img data-tposition="position1" data-tpath="" src="https://dictator.ca/wp-content/uploads/Systemes-controle-acces-banner.jpg" alt="Banner image" class="w-100 object-center object-fill block rounded-xl">
            </div>    
        </div>
    <?php }else{ ?> 
