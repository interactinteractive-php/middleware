...
<div id="bank_widget_window_<?php echo $this->uniqId; ?>" style="width:100%">
<div class="col-md-12">
    <br>
    <div>
...
<div style="padding-right: .625rem;padding-left: .625rem;overflow: auto;">    
    <div class="mt20 chart1-div" style="background-color:#fff;float:left;width: 50%">
        <p style="font-size: 15px; font-weight: bold;">Харилцахын орлогын мэдээ</p>
        <div id="bank_widget_chart_<?php echo $this->uniqId; ?>" style="border: 1px solid rgb(155,187,89);" class="mt20 mr20"></div>	
    </div>
    <div class="mt20 chart2-div" style="background-color:#fff;float:left;width: 50%">
