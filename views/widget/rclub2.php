...
<div class="col-md-12">
    <br>
    <div>
        <h2 style="margin: 0 auto; display: table">Ривер Клуб - Борлуулалт үйлчилгээ</h2>
...
<div class="col-md-12 col-sm-12 mt20">
    ...
    <div class="col-md-3 col-sm-3" style="padding: 4px;">
        <div style="background-color: rgb(204,255,102); height: 105px; padding-left: 8px; padding-top: 1px;padding-right: 8px;">
            ...
            <p style="font-size: 18px; font-weight: bold;margin-top: 48px;text-align: right;">1,415,320</p>
        </div>
    </div>
    <?php
...
<div class="col-md-12 col-sm-12">
    <div class="col-md-7 col-sm-7 mt20 no-padding" style="background-color:#fff;">
    ...
    <div class="col-md-5 col-sm-5 mt20" style="background-color:#fff; padding-right: 0px">
...
<div class="col-md-12 col-sm-12 no-padding m-0"> 
