<div class="bg-white">
    <div class="card-body form" id="mainRenderDiv" style="">
        <div class="xs-form main-action-meta bp-banner-container " id="bp-window-<?php echo $this->uniqId ?>" data-meta-type="process" data-process-id="<?php echo $this->uniqId ?>" data-bp-uniq-id="<?php echo $this->uniqId ?>">
            <?php echo Form::create(array('class' => 'form-horizontal', 'id' => 'addbsp_report_' . $this->uniqId, 'method' => 'post')); ?>
                <?php  if ($this->seeBtn) { ?>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="text-right middle" data-cell-path="code" style="width: 23%">
                                            <label for="param[id]" data-label-path="id"><span class="required">*</span>Bsp file: </label>
                                        </td>
...
<script type="text/javascript">
    ...
    $('body').on('click', '.air-sms-btn-save-<?php echo $this->uniqId ?>', function () {
        $('#addbsp_report_<?php echo $this->uniqId ?>').validate({errorPlacement: function () {}});
        if ($('#addbsp_report_<?php echo $this->uniqId ?>').valid()) {
            $('#addbsp_report_<?php echo $this->uniqId ?>').ajaxSubmit({
                type: 'post',
