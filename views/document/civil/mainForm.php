    ...
    function erlSaveContentParamsCvl_<?php echo $this->uniqid; ?>(elem, type) {
        ...
        setTimeout(function(){
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: 'ignoreFileRender=1&type=<?php echo $this->typeId ?>&wfmStatusId=<?php echo $this->row['wfmstatusid'] ?>&civilId=<?php echo $this->civilId ?>&recordId='+$parent.data('id')+'&'+$form.serialize()+'&'+$('.main-serialize-metadata-<?php echo $this->uniqid ?>').find('input').serialize(),
                async: false, 
                success: function (responseData) {
                    ...
                    if (responseData.status == 'success') {
                        ...
                        if (responseData.hasOwnProperty('fileRender') && responseData.fileRender) {
                            ...
                            $('#dialog-erl-<?php echo $this->uniqid; ?>').modal('hide'); 
                        }
                    }     
