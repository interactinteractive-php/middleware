<div id="window-word-template-edit">
    <?php echo Form::create(array('class' => 'form-horizontal', 'id' => 'appbp-edit-template-form', 'method' => 'post')); ?>
    <div class="col-md-12 xs-form">
        <div class="form-group row fom-row">
            ...
            <div class="col-md-6">
                <?php echo Form::text(array('name' => 'templateName', 'id' => 'templateName', 'class' => 'form-control form-control-sm', 'required' => 'required', 'value' => $this->row['TEMPLATE_NAME'], 'style' => 'color:#000; border:4px #1BBC9B solid; font-weight:bold; font-size: 15px !important; height: 40px;')); ?>
            </div>
        </div>        
        <div class="form-group row fom-row">
            <?php echo Form::label(array('text' => 'Код', 'for' => 'templateCode', 'class' => 'col-form-label col-md-3', 'required' => 'required')); ?>
            <div class="col-md-6">
                <?php echo Form::text(array('name' => 'templateCode', 'id' => 'templateCode', 'class' => 'form-control form-control-sm', 'value' => $this->row['TEMPLATE_CODE'], 'required' => 'required')); ?>
            </div>
        </div>
        <div class="form-group row fom-row">
        ...
        <?php if (isset($this->row['PHYSICAL_PATH']) && $this->row['PHYSICAL_PATH']) { ?>
        <div class="form-group row fom-row">
            <?php echo Form::label(array('text' => '', 'for' => '', 'class' => 'col-form-label col-md-3', 'no_colon' => '')); ?>
            <div class="col-md-6">
                <a href="<?php echo $this->row['PHYSICAL_PATH']; ?>" target="_blank" >MS Ворд темплейт file</a>
            </div>
        </div>
        <?php } ?>
        <div class="form-group row fom-row">
