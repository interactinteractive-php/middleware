        ...
        <div class="card-body pt0">
            <div class="tab-content card-multi-tab-content">
                <div class="tab-pane active" id="app_tab_mdassetcovid_dashboard">
                    ...
                    ?>
                    <div class="content covid19 dashboard3">
                                ...
                                <div class="col p-0">
                                    <div class="row navlist">
                                        ...
                                        <div class="col">
                                            ...
                                            <?php if(isset($data1['listmetadataid'])){?>
                                            <a href="javascript:;" class="drill"  data-row="<?php echo $rowJson; ?>"  onclick="drilldownHrList(this, '','<?php echo isset($data1['listmetadataid']) ? $data1['listmetadataid'] : '' ?>')" ></a>
                                            <?php } ?>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3 left-dash">
                                            <div class="box-shadow">
                                                <div class="card-header d-flex justify-content-between">
                                                    <h6 class="mb-0"><?php echo $this->lang->line('dashboard3_chart1'); ?></h6>
                                                </div>
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-12">
                                            ...
                                            <div class="box-shadow">
                                                <div class="card-header d-flex justify-content-between">
                                                    <h6 class="mb-0"><?php echo $this->lang->line('dashboard3_chart6'); ?></h6>
                                                </div>
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-12">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="box-shadow">
                                                <div class="card-header d-flex justify-content-between">
                                                    <h6 class="lh-5"><?php echo $this->lang->line('dashboard3_chart2'); ?></h6>
                                                </div>
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-12">
                                                    ...
                                                    <div class="box-shadows">
                                                        ...
                                                        <div class="card-header">
                                                            <h6 class="mb-0"><?php echo $this->lang->line('dashboard3_chart3'); ?></h6>
                                                        </div>
                                                        <div class="card-body">
                                        ...
                                        <div class="col-sm-3 right-dash">
                                            <div class="box-shadow" id="distlist">
                                                <div class="card-header d-flex justify-content-between">
                                                    <h6 class="mb-2"><?php echo $this->datalist[0]['countryname']; ?></h6>
                                                </div>
                                                <ul class="list-group  bg-slate-600 border-0">
                                                    <?php
                                                    foreach ($this->datalist as $k => $item){
                                                        
                                                    ?>
                                                    <li class="list-group-item bordered-<?php echo $item['iswithline']?>">
                                                        <div class="desc">
                                                            <p class=""><?php echo $item['title']; ?>
                                                            <span  class="badge ml-auto"><?php echo $item['val']; ?></span></p>
                                                        </div>
                                                    </li>
                                                    <?php } ?>
                                                </ul>
                                                ...
                                                <div class="card-header">
                                                    <div class="d-sm-flex justify-content-between">
                                                        <div class="mb-0 mg-sm-b-0">
                                                            <h6 class="mb-0"><?php echo $this->lang->line('dashboard3_chart5'); ?></h6>
                                                        </div>
                                                    </div>
                                                    <div class="d-sm-flex justify-content-between">
...
?>
<style>
    #distlist .list-group .list-group-item.bordered-1{
        border-bottom:1px solid #d6e1ed3b; 
    }
    #distlist .list-group{
        padding: 25px 0;
    }
...
function drilldownHrList(element,mName,mId) {
    ...
    gridDrillDownLink(element, mName, 'metagroup', '1', '',  mId, '','', '', true, true);
}

// Setup module
// ------------------------------
var windowL = $('.covid19').height();
    $('.left-dash').find('.lchart').css('height', windowL / 2 - 115);
    $('.right-dash').find('.rchart').css('height', windowL / 2 - 130);
    $('.box-shadow').find('#map-mn-markers').css('height', windowL - 300);
...
<script type="text/javascript">
    ...
    map.addListener("clickMapObject", function(event) {
        if (event.mapObject.groupId !== undefined) {
            ...
            $('#distlist').find('.list-group').empty();
                $.ajax({
                    type: "POST",
                    url: "mdasset/selectdistrict",
                    data: { 'id': area.groupId },
                    dataType: 'json',
                    success: function(response){
                        $('#distlist').find('.card-header h6').empty().append(response.data.countryname);
                        $.each(response.data.datalistbymapdtl, function(index, value) {
                            html = '<li class="list-group-item "><div class="w-100 desc"><p class="">'+value.title+'<span class="badge  ml-auto">'+value.val+'</span></p></div></li>';
                            $('#distlist').find('.list-group').append(html).fadeIn('slow');
                        });
                        // $listwindow.append(html);
                    }
                });
