        ...
        <div class="content-wrapper dashboard">
            ...
            <div class="content dashboard">
					...
					<div class="row">
							...
							<div class="card card-body bg-blue-400 has-bg-image">
								<div class="media mb-3">
									<div class="media-body">
										<h6 class="font-weight-bold mb-0">Ээлжийн амралттай байгаа ажилтнууд</h6>
						...
						<div class="col-sm-6 col-xl-3">
							<div class="card card-body bg-danger-400 has-bg-image">
								<div class="media mb-3">
									<div class="media-body">
										<h6 class="font-weight-bold mb-0">Шийдвэрлэх хүсэлтүүд</h6>
						...
						<div class="col-sm-6 col-xl-3">
							<div class="card card-body bg-success-400 has-bg-image">
								<div class="media mb-3">
									...
									<div class="media-body">
										<h6 class="font-weight-bold mb-0">Зөрчилтэй ажилтнуудын мэдээлэл</h6>
						...
						<div class="col-sm-6 col-xl-3">
							<div class="card card-body bg-indigo-400 has-bg-image">
								<div class="media mb-3">
									...
									<div class="media-body">
										<h6 class="font-weight-bold mb-0">Баталгаажуулах хэлэлцэх асуудал</h6>
										<span class="opacity-75">April, 19th</span>
									</div>
								</div>
						...
						<div class="card card-body bg-blue-400 has-bg-image">
							<div class="media">
								...
								<div class="media-body text-right">
									<span class="text-uppercase font-size-sm">Ээлжийн амралттай байгаа ажилтнууд</span>
					...
					<div class="col-sm-6 col-xl-3">
						<div class="card card-body bg-danger-400 has-bg-image">
							<div class="media">
								...
								<div class="media-body text-right">
									<span class="text-uppercase font-size-sm">Шийдвэрлэх хүсэлтүүд</span>
					...
					<div class="col-sm-6 col-xl-3">
						<div class="card card-body bg-success-400 has-bg-image">
							<div class="media">
								...
								<div class="media-body text-right">
									<span class="text-uppercase font-size-sm">Зөрчилтэй ажилтнуудын мэдээлэл</span>
					...
					<div class="col-sm-6 col-xl-3">
						<div class="card card-body bg-indigo-400 has-bg-image">
							<div class="media">
								...
								<div class="media-body text-right">
									<span class="text-uppercase font-size-sm">Баталгаажуулах хэлэлцэх асуудал</span>
										...
										<tbody>
											<tr>
												<td>
													<div class="d-flex align-items-center">
														<div class="mr-3">
															<img height="34" width="60" src="http://www.cabinet.gov.mn/userfiles/news/855477db16b6e45e15d1405b54155085.jpg">
														</div>
														<div class="d-flex flex-column line-height-normal">
											...
											<tbody>
												<tr>
													<td>
														<div class="d-flex align-items-center">
															<div class="mr-3">
																<img height="42" width="42" class="rounded-circle" src="assets/core/global/img/user.png">
															</div>
															<div class="d-flex flex-column line-height-normal">
																<a href="javascript:void(0);" class="text-default font-weight-bold">А.Солонго-Туяа</a>
																<li class="list-inline-item">
																	<span class="text-gray">Хүний нөөцийн менежер</span>
																</li>
															</div>
														</div>
													</td>
				...
				<!-- <div class="generalbox mt-3 pb-4">
						...
						<div class="col-xl-4 col-sm-6">
							<div class="card boxlist" style="height: 378px;">
								<div class="card-img-actions">
									<img class="card-img img-fluid" src="http://www.cabinet.gov.mn/userfiles/news/855477db16b6e45e15d1405b54155085.jpg" alt="">
								</div>
								<div class="card-body">
					...
					<div class="row mt-3" style="margin-bottom: 5000px;">
						<div class="col-6">
							<div class="generalbox">
								<div class="headertitle">
