                    ...
                    <div class="card h-100 mb-0">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <span class="fs-12 text-muted mt-3">
                                    <span class="text-muted font-size-12 ml-0 mt-1">өмнөх 7 хоногоос</span>
                                    <strong>0.1</strong>
                                    <i class="icon-arrow-down7 font-size-12"></i>
                                </span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row mb20 mt20">
            <div class="col-6">
                <div class="card h-100">
                    <div class="card-header bg-white">
                        <h6 class="card-title">
                            <?php echo $this->lang->line('p1_cloud_lastpayment'); ?>
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="card card-table table-responsive shadow-0 mb-0">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th class="text-capitalize font-weight-bold"  style="width:30px">#</th>
                                        <th class="text-capitalize font-weight-bold" style="width:180px"><?php echo $this->lang->line('pcustomer'); ?></th>
                                        <th class="text-capitalize font-weight-bold"style="width:100px"><?php echo $this->lang->line('pinvoice'); ?></th>
                                        <th class="text-capitalize font-weight-bold text-center"  style="width:150px"><?php echo $this->lang->line('pdate'); ?></th>
                                        <th class="text-capitalize font-weight-bold"><?php echo $this->lang->line('pprice'); ?></th>
                                        <th class="text-capitalize font-weight-bold"><?php echo $this->lang->line('pstatus'); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    $i = 1;
                                    foreach ($this->p7 as $k => $data) {
                                    ?>
                                    <tr>
                                        <td><?php echo $i; ?></td>
                                        <td>
                                            <li class="media d-flex align-items-center">
                                                <div class="mr-2 position-relative">
                                                    <img src="<?php echo $data['objectphoto']; ?>" class="rounded-circle" width="30" height="30" alt="">
                                                </div>
                                        ...
                                        <!-- <td><?php echo $data['wfmstatuscolor']; ?></td> -->
                                        <td><?php echo date('Y-m-d h:m', strtotime($data['orderdate'])); ?></td>
                                        <td class="font-weight-bold  text-a-right bigdecimalInit" data-mdec='0'><?php echo $data['linetotalprice']; ?></td>
                                        <td class="text-center">
                                            <button type="button" class="btn py-1" style="background:<?php echo $data['wfmstatuscolor']; ?>"><?php echo $data['wfmstatusname']; ?></button>
                                        </td>
                                    </tr>
                                    <?php $i++; } ?>
                                </tbody>
            ...
            <div class="col-6">
                <div class="card h-100 top-pro">
                    <div class="card-header bg-white">
                        <h6 class="card-title">
                            <?php echo $this->lang->line('p1_cloud_newsales'); ?>
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="card card-table table-responsive shadow-0 mb-0">
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-capitalize font-weight-bold"><?php echo $this->lang->line('pinvoice_name'); ?></th>
                                        <th class="text-capitalize font-weight-bold"><?php echo $this->lang->line('pinvoice_Category'); ?></th>
                                        <th class="text-capitalize font-weight-bold"><?php echo $this->lang->line('pinvoice_price'); ?></th>
                                        <th class="text-capitalize font-weight-bold"><?php echo $this->lang->line('pinvoice_status'); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    $i = 1;
                                        foreach ($this->p8 as $k => $data) {
                                    ?>
                                    <tr>
                                        <td><?php echo $i; ?></td>
                                        <td>
                                            <li class="media d-flex align-items-center">
                                                <div class="mr-3 position-relative">
                                                    <img src="<?php echo $data['photo']; ?>" width="44" height="44" alt="">
                                                </div>

                                                <div class="media-body">
                                                    <div class="d-flex justify-content-between">
                                                        <a href="javascript:void(0);" class="font-size-14 text-black font-weight-bold"><?php echo $data['name']; ?></a>
                                                    </div>
                                                    <span class="text-grey"><?php echo $data['itemcode']; ?></span>
                                                </div>
                                            </li>
                                        </td>
                                        <td><?php echo $data['itemcategoryname']; ?></td>
                                        <td class="font-weight-bold  bigdecimalInit text-center" data-mdec='0' ><?php echo $data['price']; ?></td>
                                        <td class="text-center">
                                            <button type="button" class="btn py-1" style="background:<?php echo $data['wfmstatuscolor']; ?>"><?php echo $data['wfmstatusname']; ?></button>
                                        </td>
                                    </tr>
