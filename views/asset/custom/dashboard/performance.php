    ...
    <div class="container-fluid">
        ...
        <div class="row top">
            <div class="col-md-6">
                <div class="box-shadow ">
                    <div class="card-header d-flex justify-content-between">
                        <h6 class="mb-0"><?php echo $this->lang->line('p1performance2'); ?></h6>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="box-shadow ">
                    <div class="card-header d-flex justify-content-between">
                        <h6 class="mb-0"><?php echo $this->lang->line('p1performance3'); ?></h6>
                    </div>
                    <div class="card-body">
        ...
        <div class="row middle">
            <div class="col-sm-2 col-md-4">
                <div class="box-shadow ">
                    <div class="card-header d-flex justify-content-between">
                        <h6 class="mb-0"><?php echo $this->lang->line('p1performance4'); ?></h6>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-2 col-md-4">
                <div class="box-shadow ">
                    <div class="card-header d-flex justify-content-between">
                        <h6 class="mb-0"><?php echo $this->lang->line('p1performance5'); ?></h6>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-2 col-md-4">
                <div class="box-shadow ">
                    <div class="card-header d-flex justify-content-between">
                        <h6 class="mb-0"><?php echo $this->lang->line('p1performance6'); ?></h6>
                    </div>
                    <div class="card-body">
...
<script type="text/javascript">
    ...
    var data33 = groupBy(p1section6, 'category');
    var dataTemp5 = [];
    for(var key in data33){
        for(var i=0; i < data33[key].length; i++) {
            if (!dataTemp5[i]) {
              dataTemp5[i] = {};
            }            
            dataTemp5[i][key] = data33[key][i]['val1'];
            dataTemp5[i]['name'] = data33[key][i]['name'];
        }
    }    

    var data33 = groupBy(p1section7, 'category');
    var dataTemp6 = [];
    for(var key in data33){
        for(var i=0; i < data33[key].length; i++) {
            if (!dataTemp6[i]) {
            ...
            dataTemp6[i][key] = data33[key][i]['val1'];
            dataTemp6[i]['name'] = data33[key][i]['name'];
        }
    }    
