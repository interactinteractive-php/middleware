<div class="content hr-main1">
    <div class="container-fluid">
        <a href="javascript:;" class="send-email-hrdashboard" title="Имэйл илгээх" style="position: absolute;right: 45px;top: 0px;color:#000;font-size: 14px;">
...
<script type="text/javascript">
    ...
    $('.send-email-hrdashboard').on('click', function() { 
            ...
            $.when(
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var node = $('.content-wrapper:last')[0];

                         domtoimage.toPng(node, {filter: htmlToImageTagFilter}).then(function(dataUrl) {  

                             $('#report-mail-form', '#' + $dialogName).find('#emailFile').val('<img src="' + dataUrl + '" style="width:100%;"/>');
