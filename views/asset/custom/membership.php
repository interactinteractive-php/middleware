                ...
                <div class="tab-pane active" id="app_tab_mdassetcovid_dashboard">
                    ...
                    <div class="content covid19 dashboard3">
                        <div class="container-fluid p-0">
                            ...
                            <!-- <div class="row">
                                <div class="col-auto " id="filter">
                                    <ul class="filter box-shadow">
                                        <li><a href="javascript:;" class="btn btn-default">2</a></li>
                                        <li><a href="javascript:;" class="btn btn-default">2</a></li>
                                        <li><a href="javascript:;" class="btn btn-default">2</a></li>
                                        <li><a href="javascript:;" class="btn btn-default">2</a></li>
                                        <li><a href="javascript:;" class="btn btn-default">2</a></li>
                                        ...
                                        <li><a href="javascript:;" class="btn btn-default">2</a></li>
                                        <li><a href="javascript:;" class="btn btn-default">2</a></li>
                                        <li><a href="javascript:;" class="btn btn-default">12</a></li>
                                        <li><a href="javascript:;" class="btn btn-default">12</a></li>
                                        <li><a href="javascript:;" class="btn btn-default">12</a></li>
                                        <li><a href="javascript:;" class="btn btn-default">12</a></li>
                                        <li><a href="javascript:;" class="btn btn-default">12</a></li>
                                ...
                                <div class="col p-0">
                                            ...
                                            <div class="box-shadow  <?php echo $color1[$k]; ?> ">
                                                <div class="d-flex align-items-center text-white">
                                                    <div class=" w-100 desc row justify-content-around">
                                                        ...
                                                        <div class="col"> <span  style="font-size: 32px;text-align:right"><a href="javascript:;" class="text-white" ><?php echo $data1['code']; ?></a></span></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                                                ...
                                                                ?>
                                                                    <div class="col codate">
                                                                        <div
                                                                            ...
                                                                            <div class="mr-3">
                                                                                <a href="javascript:vo class="btn btn-default"pid(0);"
                                        ...
                                        <div class="col-sm-3 right-dash">
                                            ...
                                            <div class="box-shadow">
                                                <div class="card-header d-flex justify-content-between">
                                                    <h6 class="mb-0"><?php echo $this->lang->line('dashboard3_chart4'); ?></h6>
                                                </div>
...
<script type="text/javascript" src="assets/core/js/plugins/charts/amcharts/ammap_amcharts_extension.v2.js"></script>
...
<script type="text/javascript">
    ...
    var chart = AmCharts.makeChart("chartdiv_pie3", {
        "theme": "none",
        "type": "serial",
