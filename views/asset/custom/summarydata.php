    ...
    <div class="container-fluid">
        ...
        <div class="row navlistTop">
            <?php
                ...
                $i = 0;
                foreach ($this->layoutPositionArr['hr_pos_1'] as $k => $data1) {
                    if (++$i == 5) break;
                ?>
                    <div class="col">
                    ...
                    <div class="card-body">
                        <div class="row mt-4 mb-4">
                            <?php 
                                ...
                                foreach ($this->layoutPositionArr['hr_pos_6'] as $k => $data1) { ?>
...
<script type="text/javascript">
    ...
    AmCharts.makeChart("chartdiv_pie1", {
        ...
        "titles": [],
        "dataProvider": <?php echo json_encode($this->layoutPositionArr['hr_pos_2']); ?>
    });
    ...
    AmCharts.makeChart("longColumn", {
        ...
        "dataProvider": <?php echo json_encode($this->layoutPositionArr['hr_pos_3']); ?>
    });
    ...
    var chart = AmCharts.makeChart("tornado_negative_stack", {
        ...
        "rotate": true,
        "marginBottom": 50,
        "dataProvider": <?php echo json_encode($this->layoutPositionArr['hr_pos_4']); ?>,
        "startDuration" : 1,
        "graphs": [{
            "fillAlphas": 0.8,
            "lineAlpha": 0.2,
    ...
    am4core.ready(function() {
        ...
        var chart = am4core.create("movingbullets", am4charts.XYChart);
            ...
            chart.data = <?php echo json_encode($this->layoutPositionArr['hr_pos_5']); ?>;
