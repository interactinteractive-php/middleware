        ...
        <div class="card card-sidebar-mobile">
            <div class="card-body p-0">
                <ul class="nav nav-tabs nav-tabs-bottom border-bottom-0 nav-justified mb-0">
                    <li class="nav-item"><a href="#bottom-justified-divided-tab1" class="nav-link active text-uppercase font-weight-bold" data-toggle="tab"><?php echo Lang::line('EA_LAYOUT_001') ?></a></li>
                    <li class="nav-item"><a href="#bottom-justified-divided-tab2" class="nav-link text-uppercase font-weight-bold" data-toggle="tab"><?php echo Lang::line('EA_LAYOUT_002') ?></a></li>
                </ul>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body pt-0">
                                <form id="filter-form-<?php echo $this->uniqId ?>" action="javascript:void(0);">
                                    ...
                                    if ($ticket) {
                                        echo '<button type="button" class="btn bg-blue btn-block mt-3 font-weight-bold text-uppercase filter-btn-<?php echo $this->uniqId ?>">Шүүх</button>';
                                    }
                                    ?>
