...
<form>
    <div class="row" id="p-exp-<?php echo $this->uniqId; ?>">
        ...
        <div class="col-md-2 pr0" style="width: 13.667%;min-height: 400px;flex: 0 0 13.667%;max-width: 13.667%;">
            ...
            if ($this->isKpiField) {
            ?>
            <button class="btn p-exp-operator" type="button" onclick="insertPayrollOperator(this, 'kpiField');" title="KPI Field"><i class="icon-compose"></i></button>
            
                <?php
                if ($this->kpiCalculateFunctions) {
                ?>
                <div class="btn-group">
                    <button type="button" class="btn p-exp-operator dropdown-toggle" data-toggle="dropdown" aria-expanded="false" title="Functions"></button>
                    <div class="dropdown-menu">
                        <?php
                        foreach ($this->kpiCalculateFunctions as $calcFnc) {
                        ?>
                        <a href="javascript:;" class="dropdown-item" onclick="insertPayrollOperator(this, '<?php echo $calcFnc['FUNCTION_NAME']; ?>(\'\')');">
                            <?php echo $calcFnc['NAME']; ?>
                        </a>
                        <?php
                        }
                        ?>
        ...
        ?>
        <div class="col-md-10 pl0" style="width: 86.333%;flex: 0 0 86.333%;max-width: 86.333%;">
            <div class="p-exp-area" id="p-exp-area" contenteditable="true" style="height: 433px;min-height: 433px;max-height: 433px;">
                <?php echo $this->expression; ?>&nbsp;
            </div>
        </div>
        <?php
