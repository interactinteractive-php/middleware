                                                ...
                                                <div class="next-generation-input-wrap" style="width: 210px">
                                                    <div class="next-generation-input-label blue" style="width:60%">
                                                        ...
                                                        <div class="next-generation-input-group">
                                                            <div class="meta-autocomplete-wrap">
                                                                <div class="input-group">
                                                                    <input type="hidden" id="calcId_valueField" class="calcId_valueField" name="calcId" value="<?php echo isset($this->salaryBookInfo) ? $this->salaryBookInfo['CALC_ID'] : issetParam($this->getSuggestionInfo['id']); ?>" data-startdate="<?php echo isset($this->salaryBookInfo) ? issetParam($this->salaryBookInfo['START_DATE']) : issetParam($this->getSuggestionInfo['startdate']); ?>" data-enddate="<?php echo isset($this->salaryBookInfo) ? issetParam($this->salaryBookInfo['END_DATE']) : issetParam($this->getSuggestionInfo['enddate']); ?>" required="required">
                                                                    <input type="text" id="calcCode_displayField" name="calcCode"<?php echo !isset($this->salaryBookInfo) && $configCriteriaTemplate == '1' ? ' disabled' : ''; ?> class="form-control form-control-sm meta-autocomplete-salary lookup-code-autocomplete-salary calcCode_displayField" value="<?php echo isset($this->salaryBookInfo) ? $this->salaryBookInfo['CALC_CODE'] : issetParam($this->getSuggestionInfo['calccode']); ?>" required="required" title="" placeholder="Код" data-metadataid="0" data-processid="0" data-lookupid="<?php echo $this->lookUpCalc['META_DATA_ID']; ?>" data-lookuptypeid="<?php echo $this->lookUpCalc['META_TYPE_ID']; ?>">                                                                        
                                                                    <span class="input-group-btn">
                                                    ...
                                                    <div class="next-generation-input-body blue" style="width:40%">
                                                        <?php echo isset($this->salaryBookInfo) ? $this->salaryBookInfo['CALC_NAME'] : issetParam($this->getSuggestionInfo['calcname']); ?>
                                                    </div>
                                                </div>
                                            </div>                                          
                                            <div class="col-md-auto">
                                                <div style="width: 100px">
                                                    ...
                                                    <input type="hidden" name="calcTypeName" value="<?php echo isset($this->salaryBookInfo) ? $this->salaryBookInfo['CALC_TYPE_NAME'] : ''; ?>">
