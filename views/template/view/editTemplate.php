...
<div class="col-md-12 xs-form">
    ...
    <div class="form-group row fom-row">
        <?php echo Form::label(array('text' => $this->lang->line('item_parent_category'), 'for' => 'templateId', 'class' => 'col-form-label col-md-3')); ?>
        <div class="col-md-9">
            <?php 
            echo Form::select(
                array(
    ...
    <div class="tabbable-line">
        ...
        <div class="tab-content pb0">
            <div class="tab-pane active" id="edit-rt-permission">
                <?php echo Form::button(array('class' => 'btn btn-sm green-meadow', 'value' => '<i class="icon-plus3 font-size-12"></i> Хэрэглэгч нэмэх', 'onclick' => 'mdUserSelection();')); ?>
                <table class="table table-bordered table-advance table-hover mt5 mb0" id="rt-user-list">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td><input type="hidden" name="rtUserId[]" data-userid="<?php echo $user['USER_ID']; ?>" value="<?php echo $user['USER_ID']; ?>"><?php echo $user['LAST_NAME']; ?></td>
