...
if (isset($this->getNDDprintPosition) && is_array($this->getNDDprintPosition)) {
    ...
    $defaultTop = $marginTop = $defaultLeft1 = $marginLeft1 = $defaultLeft2 = $marginLeft2 = $defaultLeft3 = $marginLeft3 = 0;
    ...
    foreach ($this->getNDDprintPosition as $key => $value) {
        ...
        if ($key == 0) {
            ...
            $width = ($this->getNDDprintPreview['col1Width'] + $this->getNDDprintPreview['col2Width'] + $this->getNDDprintPreview['col3Width']) * 3.7795275590551;
            ...
            $marginLeft3 = ($value['colThreeLeft'] - $defaultLeft1) * 3.7795275590551;
