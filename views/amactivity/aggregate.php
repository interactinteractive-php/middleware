<div class="col-md-12 pl0 pr0" id="amactivityAggregateMaindWindow">
    <div class="card light shadow">
        ...
        <div class="card-body form xs-form display-none top-sidebar-content mb10" style="display: none;">
        <div class="row">
            ...
            <div class="col-md-12 mt10" style="margin-left: -14px">
                ...
                <div class="btn-group btn-group-devided text-right float-right" style="margin-right: -20px;">
                    <a onclick="amactivityObj.amactivityColumnConfig()" title="Тохиргоо" class="btn float-right btn-sm btn-circle blue ml5" href="javascript:;"><i class="fa fa-cog"></i></a>
                    <?php
                        echo Html::anchor(
                                'javascript:;', '<i class="fa fa-file-excel-o"></i>', array(
                                'class' => 'btn btn-secondary btn-circle btn-sm default dataExportExcelBtnAmactivity',
                                'title' => $this->lang->line('excel_btn'),
                                'data-formdata' => '',
                                'onclick' => 'amactivityObj.dataExportToExcelAmactivity(this);'
                            ), true
                        );
                        echo Html::anchor(
            ...
            <div class="col-md-12">
                <div class="row">                       
                    <div class="col-md-12 jeasyuiTheme3 mt5" id="dataGridDiv">
                        <table class="no-border mt0" id="aggregatedatagrid_<?php echo $this->activityKeyId ?>" style="width: 100%; "></table>
                    </div> 
                </div>
...
<script type="text/javascript">        
    ...
    $.getScript('middleware/assets/js/amactivity_oop.js', function() {
        ...
        if(activityKeyId !== '0000009'){
            amactivityObj.loadDataGridAggregate();        
        }
    });
