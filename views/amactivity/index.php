<div class="col-md-12 pl0" id="amactivityMaindWindow">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="bp_main_tab_1487128569927652__"><!-- banner -->
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">                                            
                                                        <div class="form-group row fom-row" id="activityPeriodSelect">
                                                            <div class="col-md-10 col-xs-12">
                                                                <div class="next-generation-input-wrap">
...
<!--                                                    <div class="col-md-4">
                                                        <div class="form-group row fom-row">
                                                            <div class="col-md-8 col-sm-7 col-xs-12">
                                                                <div id="umObjectSelectedList_<?php echo $this->uniqId; ?>" style="margin-top: -3px;" class="umObjectSelectedList">
                                                                  <div class="form-body">
                                                                      <?php if(count($this->mapDatas)) { ?>
                                                                        <div class="form-group row fom-row">
                                                                            <div class="object-div">
                                                                                <i class="fa fa-times remove-object-btn" data-meta-group-id="1448330985877" data-tablename="CRM_CUSTOMER"></i>
                                                                                <div class="object-name" data-object-name="CUSTOMER">CRM_CUSTOMER</div>
                                                                                <div class="object-record">
                                                                                    <div class="parent-meta">
                                                                                        <ul class="metas-div">
                                                                                            <?php foreach($this->mapDatas as $rVal) { ?>
                                                                                                <li class="one-target-meta">
                                                                                                    <a href="javascript:;" class="tag"><span class="dot"></span><?php echo empty($rVal['CUSTOMER_NAME']) ? $rVal['DEPARTMENT_NAME'] : $rVal['CUSTOMER_NAME']; ?>
                                                                                                        <i class="fa fa-times remove-one-target-meta" data-tablename="<?php echo $rVal['TRG_TABLE_NAME']; ?>" data-item-id="<?php echo $rVal['TRG_RECORD_ID']; ?>"></i>
                                                                                                    </a>
                                                                                                </li>
                                                                                            <?php } ?>
                                                                                        </ul>
                                                                                        <input type="text" class="form-control form-control-sm autoCompleteUmMetaData ui-autocomplete-input" id="input_1448330985877" data-meta-group-id="1448330985877" data-tablename="CRM_CUSTOMER" placeholder="" data-meta-value-name="customername" autocomplete="off">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
...
<!--                                            <div class="tab-pane" id="commonSelectableTabBasket">
                                                <div class="row" style="margin-left: 0">
                                                    <button type="button" class="btn green-meadow btn-circle btn-sm" onclick="alert('Batja service ee ogno uu.');">Илгээх</button>
                                                </div>
                                                <div class="table-toolbar"></div>
                                                <div class="row selectableGrid-row">
                                                    <div class="col-md-12 jeasyuiTheme3 selectableGrid-datatable" style="width:100%;">    
                                                        <table id="commonSelectableBasketDataGrid"></table>
                                                    </div>
                                                </div>                                      
                                            </div>                                                                                                                        -->
                                        </div>
...
<!--                                <div class="btn-group mr5">
                                    <button class="btn btn-success btn-circle btn-sm dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"><i class="icon-plus3 font-size-12"></i> Цэс</button>
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a onclick="dataViewCustomSelectableGrid('DVEmployeekey', 'multi', 'selectedActivityFunction', '', 'employee', '');" href="javascript:;"><i class="icon-plus3 font-size-12"></i> Ажилтнаар</a></li>
                                    </ul>
                                </div>-->          
                                <?php 
//                                    echo Html::anchor(
//                                        'javascript:;', '<i class="fa fa-trash"></i> Устгах', array(
//                                        'class' => 'btn btn-danger btn-circle btn-sm',
//                                        'title' => '',
//                                        'disabled' => 'disabled',
//                                        'onclick' => 'deleteActivityFunction();'
//                                    )); 
                                ?>                       
<!--                                <a class="btn btn-warning btn-circle btn-sm" title="Төсөв бүртгэх" href="javascript:;">
                                ...
                                <?php /*echo Html::anchor(
                                        'javascript:;', '<i class="fa fa-cog"></i>', array(
                                        'class' => 'btn btn-secondary btn-sm btn-circle default dataViewConfig hidden',
                                        'title' => 'Тохиргоо',
                                        'onclick' => 'dataViewAdvancedConfig_' . $this->activityKeyId . '(this);'
                                    ), true
                                    );*/ 
                                    /*echo Html::anchor(
                                        ...
                                        'class' => 'btn btn-danger btn-circle btn-sm',
                                        'title' => '',
                                        'onclick' => 'amactivityObj.deleteActivity(\'activity\');'
                                    ));*/    
                                    echo Html::anchor(
                                        'javascript:;', '<i class="fa fa-save"></i> Хадгалах', array(
                                        'class' => 'btn blue btn-circle btn-sm ml5',
                                        'title' => '',
                                        'onclick' => 'amactivityObj.calculateExpression();'
                                    )); 
                                ?>
                                <button type="button" class="btn green-meadow btn-circle btn-sm" id="addUmObjectBtn"><i class="icon-plus3 font-size-12"></i> Хамаарал нэмэх</button>
