...
<?php } ?>
            <form class="form-horizontal xs-form" role="form" method="post" id="saveBillRate-form">
                <div class="form-body">
                    <div class="row">
                        <fieldset class="collapsible">
                            ...
                            <div class="row"> 
                                ...
                                <div class="col-md-5 col-sm-5">
                                    <div class="form-group row">
                                        <?php echo Form::label(array('text' => 'Дуусах огноо', 'for' => 'toDate', 'class' => 'col-form-label col-md-4 cashrate-label', 'style' => 'font-size: 12px !important')); ?>
                                        <div class="col-md-3">
                                    ...
                                    <div class="form-group row hidden">
                                        <?php echo Form::label(array('text' => 'Эхлэх огноо', 'for' => 'fromDate', 'class' => 'col-form-label col-md-4 cashrate-label', 'style' => 'font-size: 12px !important')); ?>
                                        <div class="col-md-3">
                                            <div class="dateElement input-group">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group double-between-input" data-section-path="<?php echo Mdgl::$customerListDataViewCode; ?>">
                                                <?php echo Form::hidden(array('name' => 'customerId_valueField', 'id' => 'customerId_valueField', 'value' => $this->customerId)) ?>
                                                <?php echo Form::text(array('name' => 'customerCode_displayField', 'id' => 'customerCode_displayField', 'value' => $this->customerCode, 'class' => 'form-control form-control-sm meta-autocomplete glCode-autocomplete', 'placeholder' => 'кодоор хайх')); ?>
                                                ...
                                                <span class="input-group-btn">
                                                    <?php echo Form::text(array('name' => 'customerName_nameField', 'id' => 'customerName_nameField', 'value' => $this->customerName, 'class' => 'form-control form-control-sm meta-autocomplete glName-autocomplete', 'placeholder' => 'нэрээр хайх')); ?>    
                                                </span>     
                                            </div>
                                        </div>
                                    </div>                                                                          
                            ...
                            <div class="row">
                                <div class="col-md-5 col-sm-5">
                                    <div class="form-group row">
                                        <?php echo Form::label(array('text' => 'Валют', 'for' => 'currencyId', 'class' => 'col-form-label col-md-4 cashrate-label', 'style' => 'font-size: 12px !important')); ?>
                                        <div class="col-md-8">
                                            <?php
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group double-between-input" data-section-path="fin_account_list">
                                                <?php echo Form::hidden(array('name' => 'accountId_valueField', 'id' => 'accountId_valueField', 'value' => $this->accountId)) ?>
                                                <?php echo Form::text(array('name' => 'accountCode_displayField', 'id' => 'accountCode_displayField', 'value' => $this->accountCode, 'class' => 'form-control form-control-sm meta-autocomplete glCode-autocomplete accountCodeMask', 'placeholder' => 'кодоор хайх')); ?>
                                                <span class="input-group-btn">
                                                    <button type="button" class="btn default btn-bordered form-control-sm mr0" onclick="dataViewCustomSelectableGrid('fin_account_list', 'single', 'accountSelectableGrid', '', this);"><i class="fa fa-search"></i></button>
                                                </span>     
                                                <span class="input-group-btn">
                                                    <?php echo Form::text(array('name' => 'accountName_nameField', 'id' => 'accountName_nameField', 'value' => $this->accountName, 'class' => 'form-control form-control-sm meta-autocomplete glName-autocomplete', 'placeholder' => 'нэрээр хайх')); ?>    
                                                </span>     
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row" id="headerParam">                              
                                <div class="col-md-5 col-sm-5">
                                </div> 
                                <div class="col-md-7 col-sm-7 text-right pt5">
                                    <button type="button" class="btn btn-sm btn-circle green-meadow" onclick="calcSearchCurrencyRate2();"><i class="fa fa-search"></i> Шүүх</button>                        
                                    <button type="button" class="btn btn-sm btn-circle blue-madison" onclick="calcCurrencyRate();">Тэгшитгэх</button>                    
                                </div>
                            </div>                             
                        </fieldset>
                        <br />
                        <div class="panel-body-billContent" style="font-size:10.5px;">
                            <table class="table table-sm table-bordered table-hover" id="customerBillGrid" cellspacing="0" width="100%">
                                <thead>
                                    <tr style='width: 100%;'>
                                        ...
                                        <th style="width: 10%" class="text-center" rowspan="2">Огноо</th>
                                        <th class="text-center" rowspan="2">Баримтын дугаар</th>
                                        <th style="width: 10%" class="text-center description-calculate-currency" rowspan="2">Гүйлгээний утга</th>
                                        <th class="text-center" rowspan="2">Ханш</th>
                                        <!--<th class="text-center" colspan="2">Эхний үлдэгдэл</th>-->
                                        <th style="width: 20%" class="text-center" colspan="4">Гүйлгээ</th>
                                        <th style="width: 15%" class="text-center" colspan="2">Эцсийн үлдэгдэл</th>
                                        <th class="text-center" rowspan="2">Шинэ ханш</th>
                                        <th style="width: 15%" class="text-center" colspan="2">Зөрүү</th>
                                        <th class="equalise text-center" rowspan="2">
                                            <div class="text-center" class="mb5">Тэгшитгэх<br> эсэх </div>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td></td>
<!--                                        <td class="SUM text-right"><span id="footBeginBase" class="bigDecimalInit">0</span></td>
                                        <td class="SUM text-right"><span id="footBegin" class="bigDecimalInit">0</span></td>-->
            ...
            <div class="form-actions mt10">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <?php echo Form::button(array('class' => 'btn btn-circle btn-sm btn-success bp-btn-save', 'onclick' => 'saveBillRate();', 'value' => '<i class="fa fa-save"></i> ' . $this->lang->line('save_btn'))); ?>
                        <?php echo Form::button(array('class' => 'btn btn-circle btn-sm default cancelCashrate', 'value' => $this->lang->line('cancel_btn'))); ?>
                    </div>
                </div>
            </div>
            </form>
...
//        });
    ...
    function nextTRTDinput(event) {
        ...
        if(event.which === 13) {
            if(!parent.next().children().hasClass('moreEqualizerVarianceDebit')) {
                ...
                _this.closest('div.ui-dialog').find('.ui-dialog-buttonset button').focus();
            } else {
                parent.parent().next()
                .children("td:eq(0)")
                .children()
    ...
    function calcSearchCurrencyRate2() {
                ...
                success: function(resp) {
                    if (resp.status !== 'success') {
                        ...
                        $.each(resp.getRows, function(i, val) {
                            ...
                            if(typeof val.LAST_RATE !== 'undefined') {
                                if(val.LAST_RATE > 1)
                                    newRate = val.LAST_RATE
                            }
                            
                            var desc = val.DESCRIPTION;
                            if(val.DESCRIPTION.length > 29) {
    ...
    function calcCurrencyRate() {
        ...
        $('#customerBillGrid > tbody > tr', billWindowId).each(function() {
            var _this = $(this);
            if (_this.find('input[name="isCheck[]"]').val() == '1') {
                isCheck = 1;
                var selectedRow = {
                    'accountId': _this.find('input[name="accountId[]"]').val(),
                    'customerId': _this.find('input[name="customerId[]"]').val(),
                    'keyId': _this.find('input[name="keyId[]"]').val(),
                    bookdate: _this.find('input[name="date[]"]').val(),
                    //bookdate: $("#saveBillRate-form", billWindowId).find('#toDate').val(),
                    'rate': _this.find('input[name="equalizeRate[]"]').autoNumeric('get'),
                    'debitAmount': _this.find('input[name="varianceDebit[]"]').val(),
                    'creditAmount': _this.find('input[name="varianceCredit[]"]').val(),
                    'bookNumber': _this.find('input[name="bookNumberRow[]"]').val()
                };
...
//                            $("table#glDtl").find("th.customPartner, td.customPartner").addClass("hide");
...
//        $("input[name='equaliseAllCheck']").parent().removeClass('checked');
    ...
    function setVariaceAmount() {
        ...
        $('#customerBillGrid > tbody', billWindowId).find("tr:not(.group)").each(function() {
            ...
            ?>
            if (_this.find("input[name='isCheck[]']").val() == '1' && _this.find("input[name='equalizeRate[]']").attr('data-lastrate') == '') {
                calculateVariance(_this);
            }
            <?php
            }
            ?>
