<?php
    ...
    if ($this->components) {
      ...
      foreach ($this->components as $row) {          
         if (empty($row['LOOKUP_META_DATA_ID'])) {
             $mvCount++;
         } else {
             $metaCount++;
         }
      ...
      ?>
        <div class="col-6 view-type" onclick="relationListViewTypeMore('<?php echo str_replace([' ', '='], ['', '-'], 'Metaverse') ?>', '<?php echo 'Metaverse' ?>')">
            <div class="reldetail mt-2">                       
                <div class="d-flex align-items-center align-items-md-start flex-column flex-md-row pt-2">
                    <h5 class="reltitle line-height-normal font-size-14 font-weight-bold cursor-pointer text-select-none" style="-ms-flex: 1;flex: 1;">
                        <?php echo 'Metaverse ('.$mvCount.')'; ?>                  
                        <span class="ml-1 font-size-12" style="font-weight: normal;color: #404040;"></span>
                    </h5>
                </div>
            </div>
        </div>
        <div class="col-6 view-type" onclick="relationListViewTypeMore('<?php echo str_replace([' ', '='], ['', '-'], 'Meta') ?>', '<?php echo 'Meta' ?>')">
            <div class="reldetail mt-2">                       
                <div class="d-flex align-items-center align-items-md-start flex-column flex-md-row pt-2">
                    <h5 class="reltitle line-height-normal font-size-14 font-weight-bold cursor-pointer text-select-none" style="-ms-flex: 1;flex: 1;">
                        <?php echo 'Meta ('.$metaCount.')'; ?>                  
                        <span class="ml-1 font-size-12" style="font-weight: normal;color: #404040;"></span>
                    </h5>
                </div>
            </div>
