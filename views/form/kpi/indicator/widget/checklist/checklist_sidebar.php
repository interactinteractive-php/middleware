<div class="kpi-form-paper-portrait">
    <div class="kpi-form-paper-portrait-child">    
        ...
        <div class="row mv-checklist-render-parent mv-checklist2-render-parent" id="mv-checklist-render-parent-<?php echo $this->uniqId; ?>">
            ...
            $this->isIgnoreHeaderProcess = true;
            ?>

            <div class="col-md-4 mt15">
                <div class="mv-checklist-main-render" style="width: 100%; padding: 10px 10px;">
                    <form method="post" enctype="multipart/form-data">
                        <div class="meta-toolbar is-bp-open-">
                            ...
                            <div class="ml-auto">
                                <button type="button" class="hidden btn btn-sm btn-circle btn-success bp-btn-save" onclick="saveMvCheckListCheck(this);">
                ...
                <div class="bp-tabs tabbable-line mv-main-tabs mv-checklist-tab w-100">
                    ...
                    <div class="tab-content" style="padding-top: 0px;padding-bottom: 0px;"> 
                        ...
                        foreach ($relationTabList as $tabName => $tabRow) {
                            if ($tabName != 'яяяrow') { 
                        ?>                    
                            <div class="tab-pane <?php echo ($this->isIgnoreHeaderProcess ? ($tabId == 1 ? 'active' : '') : ''); ?> p-1" id="maintabcustom_<?php echo $this->uniqId; ?>_<?php echo $tabId; ?>" style="padding-bottom: 0 !important;padding-top: 0 !important;padding-right: 0 !important;padding-left: 0 !important;">
                                <div class="d-flex">
                                    <div class="sidebar sidebar-light sidebar-secondary sidebar-expand-md pr-2 hidden" style="width:280px">
