<div class="row mv-checklist1-render-parent" id="mv-checklist-render-parent-<?php echo $this->uniqId; ?>">
    <div class="sidebar sidebar-light sidebar-secondary sidebar-expand-md">
        <div class="sidebar-content">
            ...
            <div class="card">
                <div class="card-body mv-checklist1-menu">
...
.mv-checklist1-render-parent .mv-checklist1-menu {
    height: 70vh;
    padding: 0;
    margin-left: -10px;
    margin-right: -10px;
