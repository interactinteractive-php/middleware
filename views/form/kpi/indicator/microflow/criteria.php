    ...
    <table class="table table-hover kpi-datamart-criterias-config">
        <thead>
            <tr>
                ...
                <th style="width: 300px;">Багана</th>
                <th style="width: 100px">Operator</th>
                <th style="width: 300px;">Утга</th>
...
$(function() {
        $('#dialog-microflow-addcriteria').on('click', '.kpi-datamart-criterias-remove', function() {
            var $this = $(this), 
        ...
        $('#dialog-microflow-addcriteria').on('click', '.mircroflow-criterias-addrow', function() {
            var $this = $(this), 
