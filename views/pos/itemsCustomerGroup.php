...
if ($this->itemList) {
    $customerGroup = Arr::groupByArray($this->itemList, 'customername');

    foreach ($customerGroup as $groupKey => $groupValue) {
        if ($groupKey) {
            echo '<tr style="height: 20px;" class="multi-customer-group" data-customerid="'.$groupKey.'"><td colspan="4" style="font-size: 12px;background-color: #ffcc0099;">'.$customerGroup[$groupKey]['row']['customername'].' <a href="javascript:;" style="background-color: #e4b700;color: #333;padding: 4px 3px 3px 4px;margin-left: 13px; display:none" onclick="posCustomerList(this);">харилцагч өөрчлөх</a></td><td class="d-none"></td><td class="d-none"></td><td class="d-none"></td><td class="d-none"></td><td class="d-none"></td><td class="d-none"></td><td class="d-none"></td></tr>';
        } else {
            echo '<tr style="height: 20px;" class="multi-customer-group" data-customerid=""><td colspan="4" style="font-size: 12px;background-color: #ffcc0099;">харилцагч сонгоогүй</td><td class="d-none"></td><td class="d-none"></td><td class="d-none"></td><td class="d-none"></td><td class="d-none"></td><td class="d-none"></td><td class="d-none"></td></tr>';
        }
        foreach ($customerGroup[$groupKey]['rows'] as $itemIndex => $item) {
            ...
            if (issetParam($item['percentdiscount'])) {
            ...
            } elseif (issetParam($item['unitdiscount'])) {
                $isDiscount      = '1';
                $unitDiscount    = $item['unitdiscount'];
                $discountAmount  = $item['linetotalamount'];
                $totalDiscount   = $unitDiscount * $itemQty;
                ...
                if ($unitDiscount < 0) {
                    ...
                    $unitPrice = $item['linetotalamount'];
                }
            ...
            if (issetParam($item['isservicecharge']) == '1') {
                $qtyReadonly = ' readonly="readonly" data-accept-remove="1"';
            }
        ?>
        <tr <?php echo $trMatrixAttr; ?> data-item-id="<?php echo $item['id']; ?>" data-item-id-customer-id="<?php echo $item['id'].'_'.$item['customername']; ?>" data-customerid="<?php echo $item['customername']; ?>" data-item-code="<?php echo strtolower($item['itemcode'].$serialNumber); ?>">
            ...
            <td data-field-name="salePrice" class="text-right bigdecimalInit"><?php echo Session::get(SESSION_PREFIX.'isEditBasketPrice') !== '1' && issetParam($item['discountemployeeid']) == '' && $item['itemcode'] !== '40000099' ? $item['saleprice'] : '<input type="text" name="salePriceInput[]" class="pos-saleprice-input bigdecimalInit" value="'.$item['saleprice'].'" data-mdec="3">'; ?></td>
            ...
            <td data-field-name="quantity" class="pos-quantity-cell text-right">
                ...
                <?php if (Session::get(SESSION_PREFIX.'posTypeCode') == '3' || Session::get(SESSION_PREFIX.'posTypeCode') == '5') { ?>
                    <a href="javascript:;" class="list-icons-item basket-inputqty-button d-flex justify-content-center" title="">
                        <span class="<?php echo issetParam($item['isservicecharge']) == '1' ? 'd-none' : ''; ?>"><i class="icon-minus3 mr5"></i></span>
                        ...
                        <span class="<?php echo issetParam($item['isservicecharge']) == '1' ? 'd-none' : ''; ?>"><i class="icon-plus3 ml5"></i></span>
                    </a>            
                <?php } else { ?>
