...
<div class="row">
    <div class="col-md-12">
        <ul class="grid cs-style-2 list-view1" id="main-item-container">
            ...
            ?>
            <li class="meta <?php echo $rowMeta['META_TYPE_CODE']; ?>" id="<?php echo $rowMeta['META_DATA_ID']; ?>" data-id="<?php echo $rowMeta['META_DATA_ID']; ?>" data-folder-id="<?php echo $rowMeta['FOLDER_ID']; ?>">	
                <figure class="directory">
                    <a href="javascript:;" data-href="<?php echo $rowMeta['linkHref']; ?>" target="<?php echo $rowMeta['linkTarget']; ?>" class="folder-link" title="<?php echo $rowMeta['META_DATA_NAME']; ?>" ondblclick="<?php echo $rowMeta['linkOnClick']; ?>">
                        ...
                        <div class="box">
                            ...
                            <?php echo Mdmetadata_Model::getMetaFolderPath($rowMeta['META_DATA_ID']); ?>
                        </div>
                    </a>	
...
$(function() {
    ...
    $('ul.grid > li.meta').on('click', function() {
        var $this = $(this);
    ...
    $('ul.grid > li > figure > a').on('keydown', function(e) {
        ...
        if (isOpenContextMenu == false) {
            ...
            } else if (isShiftKey && code == 69) { /*Shift+e Edit Meta*/
