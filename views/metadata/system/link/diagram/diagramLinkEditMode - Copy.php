...
<div class="panel panel-default bg-inverse">
    <table class="table sheetTable">
        <tbody>
            <tr class="dashcollapse" style="cursor:pointer">
                <td colspan="2" style="padding: 8px;" class="">Үндсэн</td>
                <td style="padding: 8px;" class=""><i class="fa fa-caret-down" style="float: right;font-size: 16px;"></i></td>
            </tr>
            <tr class="amChartTr reversedValueAxis">
                <td style="width: 170px" class="left-padding pt10 pb10 isCardProcessTitleText"><?php echo $this->lang->line('metadata_dashboard_xaxis'); ?>:</td>
                <td colspan="2" id="xaxisTd"></td>
            </tr>
            <tr class="amChartTr reversedValueAxis">
                <td style="width: 170px" class="left-padding pt10 pb10 isCardProcessValueText"><?php echo $this->lang->line('metadata_dashboard_yaxis'); ?>:</td>
...
<div class="panel panel-default bg-inverse">
    <table class="table sheetTable">
        <tbody>
            <tr class="dashcollapse" style="cursor:pointer">
                <td colspan="2" style="padding: 8px;" class="">Харагдац</td>
                <td style="padding: 8px;" class=""><i class="fa fa-caret-up" style="float: right;font-size: 16px;"></i></td>
            </tr>   
            <tr id="dashboard-theme-tr" style="display: none;">
            ...
            <tr class="chartWidth" style="display: none;">
                <td colspan="3">
                <table style="width: 100%;"><tbody><tr>
...
<div class="panel panel-default bg-inverse">
    <table class="table sheetTable">
        <tbody>
            <tr class="dashcollapse" style="cursor:pointer">
                <td colspan="2" style="padding: 8px;" class="">Бусад</td>
                <td style="padding: 8px;" class=""><i class="fa fa-caret-up" style="float: right;font-size: 16px;"></i></td>
            </tr>     
        </tbody>
    </table>
...
<div class="panel panel-default bg-inverse">
    <table class="table sheetTable">
        <tbody>
            <tr class="chart-addon-settings-name d-none dashcollapse" style="cursor:pointer">
                <td colspan="2" style="padding: 8px;" class=""><span class="addon-configuration"></span> нэмэлт тохиргоонууд</td>
                <td style="padding: 8px;" class=""><i class="fa fa-caret-down" style="float: right;font-size: 16px;"></i></td>
            </tr>
            ...
            <tr class="animated_xy_bubble chart-addon-settings d-none">
                <td class="left-padding" style="width: 170px">Value</td>
                <td colspan="2">
                    <input type="text" name="animated_xy_bubble_value" id="animated_xy_bubble_value" class="form-control" value="<?php echo Arr::get($getAddonSettings, 'value') ?>" placeholder="Утга">
                </td>
            </tr>                
            <tr class="animated_xy_bubble chart-addon-settings d-none">
...
<script type="text/javascript">
    $(function () {
        ...
        $('.dashcollapse').click(function () {
            var $ico = $(this).find('.fa-caret-down');
            if ($ico.length) {
                $ico.removeClass("fa-caret-down").addClass("fa-caret-up");
                ...
                $ico = $(this).find('.fa-caret-up')
                $ico.removeClass("fa-caret-up").addClass("fa-caret-down")
                $(this).parent().children().each(function(i,r){
                    if (i) {
                        $(this).show();
                    }
        ...
        $(".chart-addon-settings-name.dashcollapse").trigger("click");
        ...
        $("#editFormMeta").on("change", ".chart-live-preview", function (e) {
    ...
    function setYaxis(data, defaultValue){
        ...
        var html = '<select id="yaxis" name="yaxis[]" class="chart-live-preview form-control select2" '+ isMultiple +' data-placeholder="- Сонгох -" tabindex="-1" title=""><option value="">- Сонгох -</option>';
        if (typeof data !== null) {
            var defaultValues = [];
            switch ($("#chartType").val()) { 
                case 'am_dual' :
