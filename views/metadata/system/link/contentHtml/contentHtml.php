    ...
    <tbody>
      <tr>
        ...
        <td colspan="2">
          ...
          <textarea id="contentHtml" name="contentHtml" style="display: none"><?php echo isset($this->contentHtml['CONTENT']) ? $this->contentHtml['CONTENT'] : '' ?></textarea>
          <?php
            echo Form::text(
                    array(
                        'name' => 'defaultPath',
            ...
            <?php
                echo Form::select(
                    array(
                        ...
                        'value' => $this->defaultContentTypeId
                    )
                );
            ?>
        </td>
...
<script type="text/javascript">
  ...
  function openContentHtmlPanel() {
        ...
        if ($("#" + $dialogName).children().length > 0) {
            ...
            var processMetaDataId = '<?php echo isset($this->metaDataId) ? $this->metaDataId : ''; ?>';
            $.ajax({
                type: 'post',
