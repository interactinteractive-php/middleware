                            ...
                            <table class="table group-param-configs">
                                ...
                                <tbody>
                                    ...
                                    if ($this->paramsConfigs) {
                                        if(isset($this->paramsConfigs['paramGroupConfigParamPath'])) {
...
function groupParamConfigAddRowKey(elem){
    ...
    parentTbl.find("tbody").append('<tr>'+
            ...
            '<td><?php echo Form::select(array('name' => 'paramGroupConfigParamMetaKey['.$this->params['paramPath'].'][]', 'class' => 'form-control form-control-sm', 'data' => $this->lookupMetaDataParamMetaDataKey, 'op_value' => 'META_DATA_ID','op_text' => 'FIELD_NAME| |-| |META_DATA_NAME','required' => 'required')); ?></td>'+
