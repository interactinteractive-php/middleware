        ...
        <tbody>
            <tr>
                ...
                <td>
                    ...
                    <?php echo Form::textArea(array('name' => 'graphXml', 'id' => 'graphXml', 'style' => 'display: none')); ?>
                </td>
            </tr>                  
        </tbody>
    </table>
...
var bpmEditorUi, isBpmEditorUiInit = false;
                    ...
                    $dialogContainer.dialog({
                        ...
                        buttons: [
                            {text: plang.get('save_btn'), class: 'btn btn-sm green bp-btn-subsave', click: function () {
                                ...
                                var graphXmlString = mxUtils.getXml(bpmEditorUi.editor.getGraphXml());
                                var $mxWindow = $('div.mxWindow');
...
function mainEditor(container) {
    ...
    mxUtils.getAll([bundle, STYLE_PATH + '/default.xml'], function(xhr) {
        ...
        // Main
        bpmEditorUi = new EditorUi(new Editor(urlParams['chrome'] == '0', themes), container);
