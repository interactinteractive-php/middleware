<div class="row columns">
    <div class="col-md-9">  
        <div class="editor">
            <textarea name="tempGroupEditor" id="tempEditor"><?php echo $this->htmlContent; ?></textarea>
        </div>
    </div>
    <div class="col-md-3">  
        <div class="scroller" style="max-height: 450px;" data-always-visible="0" data-rail-visible="0" data-handle-color="#dae3e7">
            <?php
...
<script type="text/javascript">
    var statementGroupEditor = CKEDITOR.replace('tempGroupEditor', {
        height: 'auto',
        width: 'auto',
    ...
    statementGroupEditor.on('contentDom', function() {
        statementGroupEditor.editable().attachListener(this.document, 'click', function(event) {
