...
<?php 
echo Form::create(array('class' => 'form-horizontal', 'id' => 'edit-theme-position-form', 'method' => 'post')); 
    
    echo Form::hidden(array('name' => 'id', 'value' => $this->id));
    echo Form::hidden(array('name' => 'metaDataId', 'value' => $this->metaDataId));
    echo Form::hidden(array('name' => 'targetMetaId', 'value' => $this->targetMetaId));
?>
        ...
        <div class="col-md-8">
            ...
            echo Form::text(
                array(
                    ...
                    'value' => Arr::get($this->row, 'LABEL_NAME')
                )
            );
            ?>
        </div>
