...
<?php echo Form::create(array('class'=>'form-horizontal', 'id'=>'editFolder-form', 'method'=>'post')); ?>
<div class="row">
    <div class="col-md-7">
        <div class="form-body">
...
<?php 
echo Form::hidden(array('name' => 'folderId', 'value' => $this->row['FOLDER_ID'])); 
echo Form::close(); 
?>  
