<div class="m-4" style="overflow-x: auto;">
    ...
    if ($this->recordList) {
        ...
        echo '<div class="d-flex flex-column mt-4 pb-4 progressstep-list">';
        foreach ($this->recordList as $key => $row) {
            $rowJson = htmlentities(json_encode($row), ENT_QUOTES, 'UTF-8');
        ?>
            <div class="d-flex progressstep-row" data-row-data="<?php echo $rowJson; ?>" style="align-items: center;margin-top: <?php echo $key ? 50: 20; ?>px;">
                <div class="d-flex flex-column" style="align-items: center;">
                    ...
                    <div style="margin-top: 52px;height: 3px;background: <?php echo $totalCount > $key ? ($row[$color] ? $row[$color] : '#b1b1b1') : 'transparent' ?>;width: 108px;rotate: 90deg;"></div>
                </div>    
