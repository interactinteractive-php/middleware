<ul class="dv-explorer10 dv-explorer" id="main-item-container">
    <?php
    if ($this->isBack) {
    ?>
...
$(function(){
    if (!$("link[href='middleware/assets/css/gridlayout/explorer10.css']").length) {
        $("head").prepend('<link rel="stylesheet" type="text/css" href="middleware/assets/css/gridlayout/explorer10.css"/>');
    }
});
</script>