<div class="row dv-explorer9 dv-explorer" id="main-item-container"> 
    <?php
    if ($this->isBack) {
    ?>
        ...
        if ($this->isGrouped == false) {
            ...
            if (isset($firstRow[$this->name1])) {
                if ($this->name1 == 'wfmstatusname' && isset($firstRow['wfmstatusid'])) {
                    $name1 = 'echo \'<span class="badge label-sm" style="background-color: \'.$recordRow[\'wfmstatuscolor\'].\'" onclick="dataViewWfmStatusFlowViewer(this, \\\'\'.$recordRow[\'id\'].\'\\\', \\\'\'.$recordRow[\'wfmstatusid\'].\'\\\', \\\'\'.$recordRow[\'wfmstatusname\'].\'\\\', \\\'\'.$this->dataViewId.\'\\\', \\\'\'.$this->refStructureId.\'\\\', \\\'\'.$recordRow[\'wfmstatuscolor\'].\'\\\');"><i class="far fa-cogs"></i> \'.$recordRow[\'wfmstatusname\'].\'</span>\';';
                } else {
            ...
            if (isset($firstRow[$this->name2])) {
                if ($this->name2 == 'wfmstatusname' && isset($firstRow['wfmstatusid'])) {
                    $name2 = 'echo \'<div class="first-title"><span class="badge label-sm" style="background-color: \'.$recordRow[\'wfmstatuscolor\'].\'" onclick="dataViewWfmStatusFlowViewer(this, \\\'\'.$recordRow[\'id\'].\'\\\', \\\'\'.$recordRow[\'wfmstatusid\'].\'\\\', \\\'\'.$recordRow[\'wfmstatusname\'].\'\\\', \\\'\'.$this->dataViewId.\'\\\', \\\'\'.$this->refStructureId.\'\\\', \\\'\'.$recordRow[\'wfmstatuscolor\'].\'\\\');"><i class="far fa-cogs"></i> \'.$recordRow[\'wfmstatusname\'].\'</span></div>\';';
                    $name3 = 'echo \'<div class="row" style="height: 1px; width: 1px; float: right; margin-right: 0;"><div class="col-md-12" style="top: 5px; right: 15px;"><div class="btn-group float-right" >
                                    <button type="button" class="btn btn-circle btn-secondary btn-sm dropdown-toggle" data-toggle="dropdown" data-close-others="true" onclick="changeWfmStatusByRow_\'.$this->dataViewId.\'(this);">
                                    </button>
                                    <ul class="dropdown-menu float-right" role="menu"></ul>
                            </div></div></div>\';';
                } else {
    ...
    ?>
    <div class="col-md-2">
        <ul class="dv-explorer9 dv-explorer">
