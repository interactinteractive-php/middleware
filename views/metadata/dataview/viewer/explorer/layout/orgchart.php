...
$(function(){
    ...
    if ($('#orgchart-container-<?php echo $this->dataViewId; ?>').length) {
        ...
        $.when(
            $.getStylesheet(URL_APP+'assets/custom/addon/plugins/jquery-orgchart/1.1.4/css/jquery.orgchart.css'), 
            $.getScript(URL_APP+'assets/custom/addon/plugins/html2canvas.min.js'),
            $.getScript(URL_APP+'assets/custom/addon/plugins/jquery-orgchart/1.1.4/js/jquery.orgchart.js') 
        ).then(function () {
