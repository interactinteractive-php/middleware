...
var ecommerceview_<?php echo $this->metaDataId; ?> = $.extend({}, $.fn.datagrid.defaults.view, {
    ...
    render: function (target, container, frozen) {
        ...
        table.push('<li datagrid-row-index=\'' + i + '\'  data-index=\'' + i + '\' class="datagrid-row media p-1 border-bottom-1 border-gray" ondblclick="pushCommerceBasket<?php echo $this->metaDataId; ?>(this);" data-row-data="' + encodeURIComponent(JSON.stringify(rows[i])) + '" style="height: 40px;">');
    ...
    renderRow: function (target, fields, frozen, rowIndex, rowData) {
        var cc = [];
            ...
            <?php
                ...
                cc.push('<img src="assets/core/global/img/user.png" width="34" height="34" class="rounded-circle" alt="" onerror="onUserImgError(this);">');
            <?php } ?>
            cc.push('</a>');
