...
<div class="intranet menucolumn">
    <div class="page-content">
        
        <div class="sidebar v2 sidebar-light sidebar-main sidebar-expand-md dv-onecol-first-sidebar" style="background: #f3f4f6;min-height: inherit;">
                    ...
                    <div class="card-body p-0">
                        <div class="ea-content-sidebar-tabs">
                            <div class="ea-first-sidebar-tabs-<?php echo $this->uniqId; ?> w-100 mr-1">
                                <ul class="nav nav-tabs v2 nav-tabs-bottom border-bottom-0 nav-justified mb-0 d-flex align-items-center ea-nav-tabs">
                                    <li class="nav-item">
                                        <a href="javascript:;" class="nav-link text-uppercase font-weight-bold" data-toggle="tab" style="text-align: left"><?php echo $this->title; ?></a>
                                    </li>
                            ...
                            <div class="d-flex flex-row ml-auto mr-2 hidden">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="dv-panel-tab1-<?php echo $this->uniqId; ?>">
                                <div class="menu-description px-2">
                                    <?php echo issetParam($this->description); ?>
                                </div>
                                <div class="d-flex mt-3 mb-2 px-2" style="gap:8px;">
