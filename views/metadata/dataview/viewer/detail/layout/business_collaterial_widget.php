<?php
if (isset($this->row['dataViewLayoutTypes']) && isset($this->row['dataViewLayoutTypes']['card_collaterial_w'])) {
    
    $typeRow = $this->row['dataViewLayoutTypes']['card_collaterial_w'];
...
var business_collaterialview_<?php echo $this->metaDataId; ?> = $.extend({}, $.fn.datagrid.defaults.view, {
    ...
    renderRow: function (target, fields, frozen, rowIndex, rowData) {
        ...
        cc.push('<div class="card-collaterial-wrapper-eui business-collaterial-card-collaterial-wrapper-eui business-collaterial-card-collaterial_w"><div class="">');  
            cc.push('<div class="image-wrapper-eui business-image-wrapper-eui" style="height:<?php echo isset($typeRow['fields']['code']) || isset($typeRow['fields']['name1']) ? '300px' : '280px'; ?>">');  
            <?php if (!empty($photoPath)) { ?>
                ...
                if (['pdf', 'doc', 'docx', 'xls', 'xlsx'].indexOf(lowerExtension) !== -1) {
                    ...
                    cc.push('<a href="<?php echo $photoField; ?>" class="fancybox-button" data-rel="fancybox-button"><img src="<?php echo $photoField; ?>" data-default-image="<?php echo $defaultImage; ?>" style="border-top-left-radius: 8px;border-top-right-radius: 8px;" width="130px" height="<?php echo isset($typeRow['fields']['code']) || isset($typeRow['fields']['name1']) ? '300px' : '280px'; ?>" onerror="onDataViewImgError(this);"/></a>');
                }                
            <?php } else { ?>            
                cc.push('<a href="<?php echo $photoField; ?>" class="fancybox-button" data-rel="fancybox-button"><img src="<?php echo $photoField; ?>" data-default-image="<?php echo $defaultImage; ?>" style="border-top-left-radius: 8px;border-top-right-radius: 8px;" width="130px" height="<?php echo isset($typeRow['fields']['code']) || isset($typeRow['fields']['name1']) ? '300px' : '280px'; ?>" onerror="onDataViewImgError(this);"/></a>');
            <?php } ?>
            ...
            cc.push('<div class="content-actions-wrapper-eui business-content-actions-wrapper-eui">');  
                cc.push('<div class="content-eui">');
                    ...
                    cc.push('<div class="date-wrapper-eui mt10 hidden">');
                        <?php
                    ...
                    cc.push('<div class="clearfix w-100"></div><div class="name4-5-wrapper-eui" title="">');
                        ...
                        ?>
                        cc.push('<div class="name4-wrapper-eui" style="display: -webkit-box;-webkit-line-clamp: 2;-webkit-box-orient: vertical;overflow: hidden;text-overflow: ellipsis;line-height: 15px;" title="'+rowData.<?php echo $name4; ?>+'">');
