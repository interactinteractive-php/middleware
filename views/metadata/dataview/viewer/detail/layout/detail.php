<?php
if (isset($this->row['dataViewLayoutTypes']) && isset($this->row['dataViewLayoutTypes']['card_detail'])) {
    
    $typeRow = $this->row['dataViewLayoutTypes']['card_detail'];
...
?>
var detailview_<?php echo $this->metaDataId; ?> = $.extend({}, $.fn.datagrid.defaults.view, {
    ...
    renderRow: function (target, fields, frozen, rowIndex, rowData) {
        ...
        cc.push('<div class="card-wrapper-eui">');  
            ...
            cc.push('</div>');  
            cc.push('<div class="content-actions-wrapper-eui detail-content-actions-wrapper-eui">');  
                cc.push('<div class="content-eui">');
                    ...
                    ?>
                    cc.push('<div class="name-wrapper-eui" title="'+rowData.<?php echo $name1; ?>+'">');
