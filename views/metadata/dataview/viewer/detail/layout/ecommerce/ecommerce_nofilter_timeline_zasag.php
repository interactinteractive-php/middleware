<?php
if (isset($this->row['dataViewLayoutTypes']) && isset($this->row['dataViewLayoutTypes']['ecommerce_nofilter'])) {
    $typeRow = $this->row['dataViewLayoutTypes']['ecommerce_nofilter'];

    (String) $photoField = $groupField = '';
    (String) $photoCircleField = $name6Field = '';
    ...
    var ecommerce_nofilterview_<?php echo $this->metaDataId; ?> = $.extend({}, $.fn.datagrid.defaults.view, {
    ...
    cc.push('<td class="photo" style="width:50px; padding:0">');
    <?php if (isset($typeRow['fields']['photo'])) {
