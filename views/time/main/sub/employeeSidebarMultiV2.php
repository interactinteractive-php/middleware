            ...
            <tbody>
                <tr>
                    ...
                    <td style="width: 50px;" colspan="<?php echo Config::getFromCache('CONFIG_TNA_HISHIGARVIN') ? '2' : '' ?>">
                        <input class="inTime timeInit <?php echo (!$this->isStartTimeEdit) ? 'readonly-inTime' : '' ?>" data-name="inTime" name="inTime" placeholder="hh:mm" <?php echo (!$this->isStartTimeEdit) ? 'readonly="readonly" style="background-color: #EBEBE4"' : '' ?> type="text" value="<?php echo isset($this->params[0]['IN_TIME']) ? $this->params[0]['IN_TIME'] : '' ?>">
                    </td>
                ...
                <tr>
                    ...
                    <td style="width: 50px;" colspan="<?php echo Config::getFromCache('CONFIG_TNA_HISHIGARVIN') ? '2' : '' ?>">
                        <input class="outTime timeInit <?php echo (!$this->isEndTimeEdit) ? 'readonly-inTime' : '' ?>" data-name="outTime" name="outTime" placeholder="hh:mm" <?php echo (!$this->isEndTimeEdit) ? 'readonly="readonly" style="background-color: #EBEBE4"' : '' ?> type="text" value="<?php echo isset($this->params[0]['OUT_TIME']) ? $this->params[0]['OUT_TIME'] : '' ?>">
                    </td>
...
<script type="text/javascript">
    $('.isAddonCheck').click(function() {
        ...
        if(!$this.closest('span').hasClass('checked')) {
            ...
            <?php if(Config::getFromCache('CONFIG_TNA_SOYOL')) { ?>
