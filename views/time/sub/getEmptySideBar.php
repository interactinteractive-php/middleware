    ...
    <table class="table sheetTable">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group">
                        ...
                        <?php echo Form::button(array('class' => 'btn btn-sm blue-hoki balancePlanCountExportExcel ml0 mr0', 'title' => 'Export excel', 'value' => '<i class="fa fa-file-code-o"></i> ')); ?>
                    </div>
                </td>
            </tr>
            <?php
            ...
            <tr>
                ...
                <td>
                    <?php echo Form::button(array('class' => 'btn btn-sm purple-plum ml0 mr0', 'title' => 'Урт хугацаагаар төлөвлөх', 'value' => '<i class="fa fa-calendar"></i> Төлөвлөгөө оноох', 'onclick' => 'callCustomByMeta(\'' . Mdtime_Model::getMetaDataIdModel('TnaEmployeeAllTimePlan_001') . '\', true);')); ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo Form::button(array('class' => 'btn btn-sm purple-plum ml0 mr0', 'title' => 'Ээлжийн гараа төлөвлөх', 'value' => '<i class="fa fa-calendar"></i> Гараа төлөвлөх', 'onclick' => 'callCustomByMeta(\'' . Mdtime_Model::getMetaDataIdModel('TnaShiftEmployeeTimePlan_001') . '\', true);')); ?>
                </td>
            </tr>
            <?php //} ?>
