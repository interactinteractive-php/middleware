        ...
        <table style="width: 100%;">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width: 50%;"><label><?php echo Form::checkbox(array('name' => 'isWorkingDays', 'id' => 'isWorkingDays', 'class' => 'form-control', 'value' => '0')); ?> Ажлын өдрөөр эсэх</label></td>
                </tr>
            </tbody>
        </table>
    </div>
...
<div class="panel panel-default bg-inverse additional-panel">
    <table class="table sheetTable">
        <tbody>
            <tr class="isVerifyBtn">
                <td style="width: 170px" class="left-padding">
                    <?php echo Form::label(array('text' => 'Ажлын өдрөөр эсэх', 'for' => 'isWorkDay', 'class' => 'col-form-label')); ?>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group">
                        <?php echo Form::button(array('class' => 'btn btn-sm balanceExportExcel ml0 mr0', 'title' => 'Export excel', 'value' => '<i class="fa fa-file-excel-o"></i> ')); ?>
                    </div>
                </td>
            </tr>
            <?php
            ...
            <tr>
                ...
                <td>
                    <?php echo Form::button(array('class' => 'btn btn-sm purple-plum ml0 mr0', 'title' => 'Урт хугацаагаар төлөвлөх', 'value' => '<i class="fa fa-calendar"></i> Төлөвлөгөө оноох', 'onclick' => 'callCustomByMeta(\'' . Mdtime_Model::getMetaDataIdModel('TmsEmployeeAllTimePlan_001') . '\', true);')); ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <?php echo Form::button(array('class' => 'btn btn-sm purple-plum ml0 mr0', 'title' => 'Ээлжийн гараа төлөвлөх', 'value' => '<i class="fa fa-calendar"></i> Гараа төлөвлөх', 'onclick' => 'callCustomByMeta(\'' . Mdtime_Model::getMetaDataIdModel('TmsShiftEmployeeTimePlan_001') . '\', true);')); ?>
                </td>
            </tr>
            <?php //} ?>
            ...
            <tr>
                ...
                <td>
                    <?php echo Form::button(array('class' => 'btn btn-sm purple-plum ml0 mr0', 'title' => 'Үүсгэх', 'value' => '<i class="fa fa-calendar"></i> Архив үүсгэх', 'onclick' => 'sendArchiv(this, '. $this->uniqId . ');')); ?>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="form-inline">
                        <div class="form-group row fom-row mb0 tnaArchiveList-<?php echo $this->uniqId ?>">
                            <?php
                        ...
                        <div class="form-group row fom-row mb0">
                            <?php echo Form::button(array('class' => 'btn btn-sm purple-plum ml0 mr0 balanceReload disabled archivEnableOrDisableBtn', 'data-uniqId' => $this->uniqId, 'title' => 'Буцах', 'value' => '<i class="fa fa-arrow-left"></i>')); ?>
                        </div>    
                        <div class="form-group row fom-row mb0">
                            <?php echo Form::button(array('class' => 'btn btn-sm purple-plum ml0 mr0 balanceReload disabled archivEnableOrDisableBtn', 'title' => 'Архив сэргээх', 'value' => '<i class="fa fa-rotate-left"></i>', 'onclick' => 'recoveryArchivDailog(this, '. $this->uniqId .');')); ?>
                        </div>    
                    </div>
                </td>
            </tr>
            <?php if ($this->isAdd) { ?>
                <tr>
                    <td class="left-padding"><?php echo Form::label(array('text' => 'Цагийн төлөвлөгөө оноох', 'for' => 'Архив үзэх')); ?></td>
                    <td>
                        <div class="form-inline">
                            <button type="button" class="btn btn-xs btn-success ml0 mr0 mb5" title="Цагийн төлөвлөгөө" onclick="callCustomByMeta('<?php echo $this->tmsMetaDataId ?>', true);"><i class="fa fa-clock-o"></i></button>  
                        </div>
                    </td>
                </tr>
            <?php } ?>
