                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 col-sm-7">
                                            <div class="row">
                                                    ...
                                                    <div class="form-group row fom-row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="dateElement input-group ml5" data-section-path="bookDate">
                                                                <?php echo Form::text(array('name' => 'startDate', 'id' => 'startDate', 'class' => 'form-control form-control-sm dateInit', 'value'=>  Date::currentDate('Y-m-d'), 'required' => 'required'));?>
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="form-group row fom-row">
                                                        <?php echo Form::label(array('text' => $this->lang->line('end_date'), 'for' => 'startDate', 'class' => 'col-form-label col-md-3', 'required' => 'required')); ?>
                                                        <div class="col-md-9">
                                                    ...
                                                    <div class="form-group row fom-row <?php echo (isset($this->golomtView) && $this->golomtView) ? 'hidden' : ''; ?>">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="input-icon right">
                                                                <input type="text" style="width: 213px !important;" id="stringValue" name="stringValue" class="form-control form-control-sm input-xxlarge" placeholder="Утгын хайлт (овог, нэр)">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row fom-row <?php echo (isset($this->golomtView) && $this->golomtView) ? '' : 'hidden'; ?>">
                                    ...
                                    <div class="form-group row fom-row">
                                        <div class="col-md-12">
                                            <div class="input-icon dateElement right">
                                                <?php echo Form::button(array('class' => 'btn btn-circle btn-sm btn-success', 'onclick' => 'getBalanceList(\''. $this->uniqId .'\')', 'value' => '<i class="fa fa-search"></i> ' . $this->lang->line('search_btn'))); ?>
                                            </div>
                                        </div>
                                    </div> 
                                    <div class="form-group row fom-row hidden">
